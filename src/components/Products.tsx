...
const Products = ({setSelected}: ChildProps) => {
    ...
    return (
        <div className={`${currentDir == "shop" ? "h-[670px] max-sm:h-[570px] max-sm:p-5 overflow-y-auto max-sm:no-scrollbar p-5" : "h-[670px] max-sm:h-[580px] overflow-y-auto max-sm:no-scrollbar p-5"}`}>
            {!loading ? (
